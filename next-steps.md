...
*   **Settings & State**: To save features like custom App Shortcuts lists, themes, sizes, predictive features (on/off), and learned words, you should use `Jetpack DataStore` (Modern replacement for SharedPreferences) so changes persist after the keyboard is closed.
